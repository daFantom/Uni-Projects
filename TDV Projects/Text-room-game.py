...
def main():
    room_list = []
    room1 = Room("You encounter yourself at the Hallway. You have 1 passage to the north, 2 to the east and 2 to the west.",1,None,2,2) # Hallway has 5 rooms it can enter.
    room_list.append(room1)
    room2 = Room("You're in the Bathroom, best to take a shower sooner than later! You have 2 entrances, south and east.",None,1,1,None) # Bathroom would be at the top left side of the map.
    room_list.append(room2)
    room3 = Room("Welcome to the Master Bedroom, best you don't do dirty things. You have 2 exits, north and east.",1,None,1,None) # Master bedroom would be below the Bathroom.
    ...
    room5 = Room("Your chef instincts rush you to the Kitchen, what will you prepare today? You can exit from the south or west",None,1,None,1) # Kitchen will be on the top right side of the map.
